...
## there will be two type of export 
- export default -- use when we have to export only one component.
-naming export -- use when we have to export more than one components.